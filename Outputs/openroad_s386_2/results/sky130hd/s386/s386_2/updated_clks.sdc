...
# Tue May 16 21:26:44 2023
###############################################################################
current_design s386
###############################################################################
# Timing Constraints
###############################################################################
create_clock -name clk -period 1.5487 
...
set_output_delay 0.2000 -clock [get_clocks {clk}] -min -add_delay [get_ports {v13_D_10}]
set_output_delay 0.5000 -clock [get_clocks {clk}] -max -add_delay [get_ports {v13_D_10}]
set_output_delay 0.2000 -clock [get_clocks {clk}] -min -add_delay [get_ports {v13_D_11}]
set_output_delay 0.5000 -clock [get_clocks {clk}] -max -add_delay [get_ports {v13_D_11}]
set_output_delay 0.2000 -clock [get_clocks {clk}] -min -add_delay [get_ports {v13_D_12}]
set_output_delay 0.5000 -clock [get_clocks {clk}] -max -add_delay [get_ports {v13_D_12}]
set_output_delay 0.2000 -clock [get_clocks {clk}] -min -add_delay [get_ports {v13_D_6}]
set_output_delay 0.5000 -clock [get_clocks {clk}] -max -add_delay [get_ports {v13_D_6}]
set_output_delay 0.2000 -clock [get_clocks {clk}] -min -add_delay [get_ports {v13_D_7}]
set_output_delay 0.5000 -clock [get_clocks {clk}] -max -add_delay [get_ports {v13_D_7}]
set_output_delay 0.2000 -clock [get_clocks {clk}] -min -add_delay [get_ports {v13_D_8}]
set_output_delay 0.5000 -clock [get_clocks {clk}] -max -add_delay [get_ports {v13_D_8}]
set_output_delay 0.2000 -clock [get_clocks {clk}] -min -add_delay [get_ports {v13_D_9}]
set_output_delay 0.5000 -clock [get_clocks {clk}] -max -add_delay [get_ports {v13_D_9}]
###############################################################################
# Environment
###############################################################################
###############################################################################
