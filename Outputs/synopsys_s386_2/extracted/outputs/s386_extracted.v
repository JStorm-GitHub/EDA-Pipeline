...
// Generated on 05/16/2023 at 20:46:12
...
INVX0_RVT U81 (.A ( v7 ) , .Y ( n71 ) ) ;
INVX1_RVT U80 (.A ( v8 ) , .Y ( n70 ) ) ;
INVX0_RVT U78 (.A ( v11 ) , .Y ( n69 ) ) ;
AO21X1_RVT U74 (.A1 ( n5 ) , .Y ( n24 ) , .A2 ( n70 ) , .A3 ( n6 ) ) ;
OA22X1_RVT U75 (.Y ( n26 ) , .A4 ( n70 ) , .A3 ( v3 ) , .A2 ( v7 ) , .A1 ( v2 ) ) ;
OA21X1_RVT U76 (.Y ( n60 ) , .A3 ( v11 ) , .A2 ( n71 ) , .A1 ( n70 ) ) ;
OR2X1_RVT U77 (.Y ( n50 ) , .A2 ( v1 ) , .A1 ( n13 ) ) ;
NAND3X0_RVT U79 (.Y ( n38 ) , .A1 ( n69 ) , .A2 ( n70 ) , .A3 ( v2 ) ) ;
INVX1_RVT U83 (.A ( v5 ) , .Y ( n17 ) ) ;
INVX1_RVT U84 (.A ( v4 ) , .Y ( n16 ) ) ;
NOR3X0_RVT U85 (.Y ( n35 ) , .A1 ( v10 ) , .A3 ( n50 ) , .A2 ( v9 ) ) ;
NAND2X0_RVT U86 (.A2 ( n71 ) , .A1 ( v2 ) , .Y ( n33 ) ) ;
INVX1_RVT U87 (.A ( v3 ) , .Y ( n15 ) ) ;
NAND3X0_RVT U88 (.Y ( n34 ) , .A1 ( n37 ) , .A2 ( n71 ) , .A3 ( n38 ) ) ;
INVX1_RVT U89 (.A ( v9 ) , .Y ( n10 ) ) ;
INVX1_RVT U90 (.A ( v12 ) , .Y ( n4 ) ) ;
AND3X1_RVT U91 (.A1 ( n69 ) , .Y ( n21 ) , .A2 ( n15 ) , .A3 ( v8 ) ) ;
INVX1_RVT U92 (.A ( v1 ) , .Y ( n14 ) ) ;
AND2X1_RVT U93 (.Y ( n20 ) , .A1 ( n4 ) , .A2 ( n10 ) ) ;
INVX1_RVT U94 (.A ( v10 ) , .Y ( n8 ) ) ;
INVX1_RVT U95 (.A ( v0 ) , .Y ( n13 ) ) ;
NAND2X0_RVT U96 (.A2 ( n8 ) , .A1 ( n49 ) , .Y ( n41 ) ) ;
AO22X1_RVT U97 (.A2 ( n50 ) , .A3 ( n51 ) , .Y ( n49 ) , .A4 ( n9 ) , .A1 ( n20 ) ) ;
INVX1_RVT U98 (.A ( n42 ) , .Y ( n9 ) ) ;
NAND3X0_RVT U99 (.Y ( n28 ) , .A1 ( v11 ) , .A2 ( n35 ) , .A3 ( n2 ) ) ;
INVX1_RVT U100 (.A ( n36 ) , .Y ( n2 ) ) ;
AND2X1_RVT U101 (.Y ( n23 ) , .A1 ( n35 ) , .A2 ( n4 ) ) ;
OAI22X1_RVT U102 (.Y ( n53 ) , .A4 ( n54 ) , .A3 ( v12 ) , .A2 ( n36 ) 
    , .A1 ( v11 ) ) ;
OA22X1_RVT U103 (.Y ( n54 ) , .A4 ( n56 ) , .A3 ( v11 ) , .A2 ( n69 ) 
    , .A1 ( n55 ) ) ;
OA22X1_RVT U104 (.Y ( n56 ) , .A4 ( n16 ) , .A3 ( n58 ) , .A2 ( n57 ) 
    , .A1 ( n15 ) ) ;
AND2X1_RVT U105 (.Y ( n51 ) , .A1 ( n71 ) , .A2 ( n70 ) ) ;
OA21X1_RVT U106 (.Y ( n42 ) , .A3 ( v0 ) , .A2 ( v9 ) , .A1 ( n14 ) ) ;
NAND2X0_RVT U107 (.A2 ( n51 ) , .A1 ( v12 ) , .Y ( n36 ) ) ;
AOI21X1_RVT U108 (.Y ( n58 ) , .A2 ( v2 ) , .A3 ( v7 ) , .A1 ( n70 ) ) ;
NAND2X0_RVT U109 (.A2 ( n33 ) , .A1 ( v8 ) , .Y ( n57 ) ) ;
OA22X1_RVT U110 (.Y ( n55 ) , .A4 ( n70 ) , .A3 ( v7 ) , .A2 ( n59 ) 
    , .A1 ( n17 ) ) ;
NAND2X0_RVT U111 (.A2 ( n70 ) , .A1 ( v7 ) , .Y ( n59 ) ) ;
NAND4X0_RVT U112 (.A2 ( n21 ) , .A4 ( n22 ) , .A3 ( v4 ) , .Y ( n19 ) 
    , .A1 ( n20 ) ) ;
AND3X1_RVT U113 (.A1 ( n8 ) , .Y ( n22 ) , .A2 ( n71 ) , .A3 ( n14 ) ) ;
AND2X1_RVT U114 (.Y ( v13_D_7 ) , .A1 ( n23 ) , .A2 ( n24 ) ) ;
OA21X1_RVT U115 (.Y ( n25 ) , .A3 ( n69 ) , .A2 ( n27 ) , .A1 ( n26 ) ) ;
AND2X1_RVT U116 (.Y ( n27 ) , .A1 ( v7 ) , .A2 ( v4 ) ) ;
NAND3X0_RVT U117 (.Y ( n47 ) , .A1 ( n48 ) , .A2 ( n8 ) , .A3 ( n20 ) ) ;
OAI21X1_RVT U118 (.Y ( n48 ) , .A3 ( n37 ) , .A2 ( n70 ) , .A1 ( n31 ) ) ;
AO21X1_RVT U119 (.A1 ( v5 ) , .Y ( n52 ) , .A2 ( v0 ) , .A3 ( n8 ) ) ;
AO21X1_RVT U120 (.A1 ( n65 ) , .Y ( Lv13_D_3 ) , .A2 ( n40 ) , .A3 ( n3 ) ) ;
NAND2X0_RVT U121 (.A2 ( n43 ) , .A1 ( n42 ) , .Y ( n40 ) ) ;
INVX1_RVT U122 (.A ( n41 ) , .Y ( n3 ) ) ;
NAND3X0_RVT U123 (.Y ( n43 ) , .A1 ( v10 ) , .A2 ( n17 ) , .A3 ( v1 ) ) ;
NAND3X0_RVT U124 (.Y ( n45 ) , .A1 ( v0 ) , .A2 ( n65 ) , .A3 ( v1 ) ) ;
NAND3X0_RVT U125 (.Y ( n29 ) , .A1 ( v8 ) , .A2 ( n30 ) , .A3 ( n23 ) ) ;
OA21X1_RVT U126 (.Y ( Lv13_D_0 ) , .A3 ( n23 ) , .A2 ( n6 ) , .A1 ( n60 ) ) ;
INVX1_RVT U127 (.A ( n37 ) , .Y ( n6 ) ) ;
NAND2X0_RVT U128 (.A2 ( n19 ) , .A1 ( n18 ) , .Y ( v13_D_9 ) ) ;
NOR2X1_RVT U129 (.Y ( v13_D_8 ) , .A2 ( n18 ) , .A1 ( v6 ) ) ;
NAND3X0_RVT U130 (.Y ( v13_D_11 ) , .A1 ( n18 ) , .A2 ( n41 ) , .A3 ( n47 ) ) ;
NAND4X0_RVT U131 (.A2 ( v0 ) , .A4 ( n10 ) , .A3 ( n39 ) , .Y ( n18 ) 
    , .A1 ( v10 ) ) ;
NAND2X0_RVT U132 (.A2 ( n16 ) , .A1 ( n21 ) , .Y ( n37 ) ) ;
NAND3X0_RVT U133 (.Y ( Lv13_D_2 ) , .A1 ( n44 ) , .A2 ( n41 ) , .A3 ( n45 ) ) ;
NBUFFX2_RVT U134 (.A ( n39 ) , .Y ( n64 ) ) ;
AND2X1_RVT U135 (.Y ( Lv13_D_1 ) , .A1 ( n35 ) , .A2 ( n53 ) ) ;
NAND2X0_RVT U136 (.A2 ( n32 ) , .A1 ( n31 ) , .Y ( n30 ) ) ;
INVX0_RVT U137 (.A ( n31 ) , .Y ( n5 ) ) ;
NAND2X0_RVT U138 (.A2 ( n29 ) , .A1 ( n28 ) , .Y ( Lv13_D_5 ) ) ;
...
AND2X1_RVT U146 (.Y ( n46 ) , .A1 ( v9 ) , .A2 ( n64 ) ) ;
INVX0_RVT U147 (.A ( n28 ) , .Y ( n1 ) ) ;
NBUFFX2_RVT U148 (.A ( n64 ) , .Y ( n65 ) ) ;
AND3X1_RVT U149 (.A1 ( n69 ) , .Y ( n39 ) , .A2 ( n4 ) , .A3 ( n51 ) ) ;
endmodule
